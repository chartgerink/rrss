...
This installs the latest version of the rtweet package, which contains some changes not currently on the CRAN distribution
...
The function will throw an error message if both of the additional arguments, following and followers, aren't set or if both = TRUE
